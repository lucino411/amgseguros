  ...
  <div class="container-fluid latin-breadcrumb">
    <div class="container">
      <div class="entry-meta"> 
        ...
        <a href="<?php echo home_url(); ?>/?post_type=<?php printf( get_post_type( get_the_ID() ) ); ?>"><?php echo apply_filters( 'Eventos Breadcrumb Categorias', 'Eventos' ); ?></a>	 
        <i class="breadcrumb-angle fa-solid fa-angle-right"> /&nbsp;</i>
        <?php 
    ...
    <div class="row">
      <div class="col-md-9">
          <header class="archive-header text-center">            
              <h2>
                  <span>
                      <a href="<?php echo home_url(); ?>/?post_type=<?php printf( get_post_type( get_the_ID() ) ); ?>"><?php echo apply_filters( 'Eventos Categorias', 'Eventos' ); ?></a>
                  </span>
              </h2>   
      ...
      <div class="col-md-3 news-taxonomy-archive-noticias">
        <div class="position-sticky" style="top: 4rem;">
          <?php echo be_filter_eventos_categories() ?>    
        </div>
      </div>
