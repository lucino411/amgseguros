	...
	?>
		...
		<h2 class="comment-title">
			<?php
				...
				printf(
					esc_html( _nx( 'One comment on &ldquo;%2$s&rdquo;', '%1$s comments on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'blastingexpertstheme' ) ),
		...
		<?php blastingexperts_get_post_navigation(); ?>
		...
		?>
			 ...
			 <p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'blastingexpertstheme' ); ?></p>
