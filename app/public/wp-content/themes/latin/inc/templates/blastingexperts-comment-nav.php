	...
	<div class="row">
		<div class="col-12 col-sm-6">
			<div class="post-link-nav">
				...
				<?php previous_comments_link( esc_html__( 'Comentarios Antiguos', 'blastingexpertstheme' ) ) ?>
			</div>
		</div>
		<div class="col-12 col-sm-6 text-right">
			<div class="post-link-nav">
				<?php next_comments_link( esc_html__( 'Comentarios Nuevos', 'blastingexpertstheme' ) ) ?>
