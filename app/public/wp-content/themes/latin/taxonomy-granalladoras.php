...
<div class="container-fluid grid-container blastingexperts-posts-container be-taxonomy">
	...
	<header class="archive-header text-center">
		<!-- <h3><small class="text-muted ">Granalladoras</small></h3> -->
		<!-- <h3 class="badge badge-secondary">Granalladoras</h3> -->
		<!-- <h3 class="">Granalladoras</h3> -->
		<!-- <h2 ><?php single_term_title(); ?></h2> -->
		<!-- <h2><?php single_term_title(); ?></h2> -->
		
		<!-- <h1 ><span class="">Granalladoras</span> <?php single_term_title(); ?></h1> -->
		
		
		<!-- <h1><?php single_term_title(); ?><span>Granalladoras</span></h1> -->
		<h1><span>Granalladoras</span><?php single_term_title(); ?></h1>
	...
	<div class="grid-card-portafolio justify-content-center">
		...
		<?php 
			...
			$args = array(
				'post_type'     => ['portafolio', 'begranalladoras'],
				'post_status'   => 'publish',
				'orderby'       => 'modified',
				'order'         => 'DESC',
