				...
				<div class="container-fluid latin-breadcrumb">
					<div class="container">
						<div class="entry-meta"> 
							...
							<a href="<?php echo home_url(); ?>/?post_type=<?php printf( get_post_type( get_the_ID() ) ); ?>"><?php echo apply_filters( 'Noticias Breadcrumb', 'Noticias' ); ?></a>	 
							<i class="breadcrumb-angle fa-solid fa-angle-right"> /&nbsp; </i>
							<?php 									 
								$title = get_the_title();
					...
					<?php 																		
						if( have_posts() ):							
							while( have_posts() ): the_post();								
								...
								get_template_part( 'template-parts/single-noticia' );
