...
<div class="container-fluid grid-container blastingexperts-posts-container be-taxonomy">
	...
	<header class="archive-header text-center">
		<!-- <h3><small class="text-muted">Boquillas, Mangueras y Acoples</small></h3>
		<h2><?php single_term_title(); ?></h2> -->
		<h1><span>Boquillas, Mangueras y Acoples</span><?php single_term_title(); ?></h1>
	</header>
