...
<div class="container-fluid single-product-main-container">
	<div class="row single-product-main-content-row">
		...
		<?php if( have_posts() ):
			...
			while( have_posts() ): the_post(); ?>
				...
				<header id="post-<?php the_ID(); ?>" class="entry-header text-center be-position-sticky single-product-header max-medium-less-screen">

					<div>
						
						<h1 class="entry-title">
							<?php echo ((strlen(get_the_title()) > 120) ? (substr(get_the_title(), 0, 120) . '') : get_the_title())?>
						</h1>
				...
				<header id="post-<?php the_ID(); ?>" class="entry-header text-center be-position-sticky single-product-header-min min-medium-screen">
				...
				<div class="entry-content be-entry-content-single clearfix col-12 col-xl-8">
		...
		<!-- <div class="col-12 col-md-8 col-xl-4 single-product-card-container"> -->
		<div class="col-12 col-md-12 col-xl-4 single-product-card-container">
							...
							<form id="__vtigerWebForm_3" name="New BE website Form" action="https://blastingexperts.od2.vtiger.com/modules/Webforms/capture.php" method="post" accept-charset="utf-8" enctype="multipart/form-data">
								...
								<div class="modal-body">
									...
									<div class="form-group">
										...
										<label class="col-form-label solicitar-politicas">Al dar clic para enviar el formulario, Ud acepta nuestros <a href="https://blastingexperts.com/wp-content/uploads/POLITICA-PRIVACIDAD-PROTECCION-TRATAMIENTO-DATOS-PERSONALES-BLASTING-EXPERTS-1.pdf" target="_blank">Términos y Condiciones</a> para el tratamiento de datos personales.</label>
									</div>
		...
		<div class="single-product-shareThis">
			<?php echo be_share_this(); ?>			
		</div>


		<!-- COLLAPSE BOOTSTRAP -->
		<div class="container-fluid container-accordion-sp">
				...
				<div class="card-header header-accordion-sp" id="modelosProducto">
					<h2 class="mb-0 ">
						<button class="btn btn-block collapsed" type="button" data-toggle="collapse" data-target="#collapseModelos" aria-expanded="false" aria-controls="collapseModelos">
							<!-- Modelos Disponibles <span class="max-medium-less-screen">en <?php the_title(); ?></span> -->
							Modelos Disponibles
						</button>
					</h2>
				</div>
		...
		<?php if( get_field('descargas_producto_multiples') ): ?>
			<div class="card">
				<div class="card-header header-accordion-sp" id="ventajasProducto">
					<h2 class="mb-0 ">
						<button class="btn btn-block collapsed" type="button" data-toggle="collapse" data-target="#collapseVentajas" aria-expanded="false" aria-controls="collapseVentajas">
				...
				<div id="collapseVentajas" class="collapse" aria-labelledby="ventajasProducto" data-parent="#ventajasProducto">
					<div class="card-body body-accordion-sp">
						<?php the_field('descargas_producto_multiples'); ?>
					</div>
				</div>
			</div>
		<?php endif; ?>
		...
		</div> <!-- container-fluid container-accordion-sp -->
		<!-- FIN COLLAPSE BOOTSTRAP -->	
...
</div> <!-- container-fluid single-product-main-container  -->
...
</div> <!-- container-fluid grid-container single-product-main-content-row -->	
